...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/damp-frost-18b3
```

A live public deployment of this template is available at [https://damp-frost-18b3.templates.workers.dev](https://damp-frost-18b3.templates.workers.dev)
